...
from utils_dense import predict, load_images, display_images
...
# Input images
[file_names, inputs] = load_images( glob.glob(args.input) )
...
# Display results
viz = display_images(file_names, outputs.copy(), inputs.copy())
